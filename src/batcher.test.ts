...
describe(`Batcher`, () => {
    ...
    describe(`newBatcher`, () => {
        it(`should create a new Batcher`, async () => {
            ...
            const batcher = newBatcher({ log: () => {}, batchSize: 100, frequency: 1000, processor, maxJobs: 5 });
    ...
    describe(`batch processing`, () => {
        ...
        it(`should run on an interval schedule`, async () => {
            ...
            const batcher = newBatcher({ log: () => {}, batchSize: 2, frequency: 1000, processor: () => jobsProcessed++, maxJobs: 5 });
            const callback = () => null;
        ...
        it(`should process all remaining jobs if the batch size is larger than the remaining jobs`, async () => {
            ...
            const batcher = newBatcher({ log: () => {}, batchSize: 10, frequency: 1000, processor: () => jobsProcessed++, maxJobs: 15 });
            const callback = () => null;
        ...
        it(`should mark started jobs as in progress, and then complete when finished, with a saved message`, async () => {
            const batcher = newBatcher({ log: () => {}, batchSize: 100, frequency: 1000, processor: asyncProcessor(500), maxJobs: 5 });
            const callback = () => null;
        ...
        it(`should mark a job as failed and save the error if an error occurs`, async () => {
            ...
            const batcher = newBatcher({ log: () => {}, batchSize: 100, frequency: 1000, processor: ({ callback }: any) => callback(), maxJobs: 5 });            
    ...
    describe(`addJob`, () => {
        it(`should return the new job with the specified callback, and default UUID name`, async () => {
            const batcher = newBatcher({ log: () => {}, batchSize: 100, frequency: 1000, processor: () => true, maxJobs: 5 });
